...
import { supportedCoins, supportedCoinsNames } from "../../Coins/coins";
import { prettyChange, prettyVolume } from "../../HelperMethods/PrettyPrint";
                    ...
                    <div className="market-data">  
                        <table>
                            <tr>
                                ...
                                <th style={{color: "darkgrey"}}>Volume(24H)</th>
                                <th style={{color: "darkgrey"}}>Change(24H)</th>
                                <th style={{color: "darkgrey"}}></th>
                            </tr>
                            {
                                ...
                                <tr>
                                    <td>
                                        <div style={{display: "flex", alignItems: "center"}}>
                                            ...
                                            <p>{item}<span style={{color: "darkgray", fontSize: "14px", paddingLeft: "6px"}}>{supportedCoinsNames[item]}</span></p>
                                        </div>
                                    </td>
                                    <td>{parseFloat(livePrices[item]).toFixed(3)}
                                        <span style={{color: "darkgray", fontSize: "14px", paddingLeft: "6px"}}>
                                            {parseFloat(livePrices[item]).toFixed(3)} USD
                                        </span>
                                    </td>
                                    <td>
                                        {prettyVolume(currDetails[item].volValue)}
                                    </td>
                                    <td style={{color: prettyChange(currDetails[item].changeRate)[1] > 0 ? "lightgreen" : "lightcoral"}}>
                                        {prettyChange(currDetails[item].changeRate)[0]}
                                    </td>
                                    <td>
                                        <button onClick={() => openModal(item)} className="coin-market-trade-but">
                                            Trade
                                        </button>
                                    </td>
                                </tr>
